...
{
	var ed = globalThis.CV.publications.conferences as ConferenceData[];
...
{
	var ed = globalThis.CV.publications.journals as JournalData[];
...
{
		var e = get_empty_conference() as ConferenceData;
...
{
		var e = get_empty_journal() as JournalData;
